...
#define STB_IMAGE_IMPLELEMENTATION
...
int main() {
    ...
    Shader shader("assets/shaders/shadow_map.vs", "assets/shaders/shadow_map.fs"),
        depthShader("assets/shaders/vertex.vs", "assets/shaders/fragment.fs"),
        depthMapShader("assets/shaders/depthMap.vs", "assets/shaders/depthMap.fs");
    GLuint floorTexture = loadTexture("assets/textures/floor.png");
    ...
    while (App->update()) {
        ...
        //depthMapShader.setFloat("far", 7.5f);
        //depthMapShader.setFloat("near", 1.0f);
        //glActiveTexture(GL_TEXTURE0);
        //glBindTexture(GL_TEXTURE_2D, depthMap);
        //renderQuad();
        //depthMapShader.end();
