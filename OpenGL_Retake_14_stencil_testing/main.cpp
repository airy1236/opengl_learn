...
int main() {
    ...
    Shader shader("assets/shaders/stencil_testing.vert", "assets/shaders/stencil_testing.frag");
    Shader shaderSingleColor("assets/shaders/stencil_testing.vert", "assets/shaders/stencil_single_color.frag");
    mTexture texture1("assets/textures/1.jpg", 0);
    mTexture texture2("assets/textures/2.jpg", 1);
