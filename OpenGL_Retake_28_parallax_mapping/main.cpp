...
void render() {
    if (VAO == 0) {
        ...
        //calculate edge and deltaUV of the first triangle
        glm::vec3 edge1 = pos2 - pos1;
        glm::vec3 edge2 = pos3 - pos1;
        glm::vec2 deltaUV1 = uv2 - uv1;
        glm::vec2 deltaUV2 = uv3 - uv1;
        //calculate the data of T and B
...
int main() {
    ...
    Shader shader("assets/shaders/parallaxMap.vert", "assets/shaders/parallaxMap.frag");

    GLuint diffuseTexture = loadTexture("assets/textures/bricks2.jpg");
    GLuint normalTexture = loadTexture("assets/textures/bricks2_normal.jpg");
    GLuint parallaxTexture = loadTexture("assets/textures/bricks2_disp.jpg");
