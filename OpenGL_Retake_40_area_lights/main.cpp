...
int main() {
    ...
    // SHADERS
    Shader shaderLTC("assets/shaders/multi_area_lights.vs", "assets/shaders/multi_area_lights.fs");
    ltcShaderPtr = &shaderLTC;
    Shader shaderLightPlane("assets/shaders/lights_plane.vs", "assets/shaders/lights_plane.fs");

    // TEXTURES
    GLuint concreteTexture = loadTexture("assets/textures/concreteTexture.png", true);
    ...
    while (App->update()) {
        ...
        glm::mat4 projection = glm::perspective(
            glm::radians(camera.getFov()), (float)scr_width / (float)scr_height, 0.1f, 100.0f);
